//	DRAFT March 31, 2011
//	Epicycloid planet gear profile of cycloid drive
...
function EvalEpicycloid( t, cylradius1, cylRadius2, numlobes, eccentricity )
{
	var psi;
	var theta;
	var z = 0.0;
	...
	// numlobes - 1 = number of lobes of the epicycloid profile.
	// numlobes + 1 = number of lobes of hypocycloid profile. (Not used here.)
	...
	psi  = Math.atan( ( Math.sin( ( 1.0 - numlobes) * theta ) ) / ( cylRadius2 / ( eccentricity * numlobes ) - Math.cos( ( 1.0 - numlobes ) * theta )));
...
function Update()
{
...

	{
		...
		var pt = EvalEpicycloid( t, cylradius1, cylRadius2, numlobes, eccentricity  );		
