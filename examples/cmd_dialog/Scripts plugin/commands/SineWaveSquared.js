...
function EvalSineWaveSquared( t, amplitude, length, numcycles )
{
	var z = 0.0;

	var y = Math.sin( t * t * Math.PI * 2.0 * numcycles ) * amplitude;
...
//	var factory = moi.command.createFactory( 'curve' );
	...
	for ( var i = 0; i < numpoints; ++i )
	{
		...
		var pt = EvalSineWaveSquared( t, amplitude, length, numcycles );		
