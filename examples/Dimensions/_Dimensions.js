// Dimensions v1.1 - Max Smirnov, Mik. 2018
...
function Dimensions()
{
	...
	if ( curves.length > 0 )
	{
		...
		while ( true )
		{
			...
			if ( e == 'decimals' || e == 'decimalsSlider' ) { moi.ui.commandUI.updateCurvedArrows( curves ) }
			if ( e == 'fontlist' ) { moi.ui.commandUI.changeFont(); moi.ui.commandUI.updateCurvedArrows( curves ) }
	...
	while ( true )
	{
		...
		if ( p == 'scale' || p == 'scaleSlider' || p == 'decimals' || p == 'decimalsSlider' ) moi.ui.commandUI.scaleValues();
		if ( p == 'fontlist' ) { moi.ui.commandUI.changeFont(); moi.ui.commandUI.scaleValues(); }
